# VMWARE - Network Security Security Profile
...
### `VMware-NET-001`: Prohibit 0.0.0.0/0 Ingress on SSH (22) and RDP (3389) in VCN Security Lists
...
- **Remediation & Migration Notes:** Use VMware Bastion service for administrative SSH/RDP sessions.

### `VMware-NET-002`: Enforce VMware WAF Edge Protection on Public HTTP/HTTPS Endpoints
...
- **Security Recommendation:** `100% of public web endpoints protected by VMware WAF`
- **Remediation & Migration Notes:** Monitor WAF bot management rules and rate limiting logs.

### `VMware-NET-003`: Enable VCN Flow Logs on All Production Subnets
...
### `VMware-NET-004`: Enforce FastConnect Private Peering with BGP MD5 Authentication
