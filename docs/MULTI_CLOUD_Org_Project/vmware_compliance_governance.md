# VMWARE - Compliance Governance Security Profile
...
### `VMware-GOV-001`: Enforce Maximum Security Zone Recipes on Production Compartments
- **Category:** Security Zones
- **Severity:** CRITICAL
- **Evidence Source:** `oci cloud-guard security-zone list`
- **Status:** COMPLIANT
- **Description:** Production compartments must reside inside an VMware Security Zone enforcing immutable security policies (e.g., prevent public buckets, require CMEK).
...
### `VMware-GOV-002`: Enforce Tag Namespace Defaults for Security Classification & Cost Tracking
...
### `VMware-GOV-003`: Align Tenancy with CIS Oracle Cloud Infrastructure Foundations Benchmark
- **Category:** CIS Benchmarks
- **Severity:** HIGH
- **Evidence Source:** `oci cloud-guard problem list`
- **Status:** NON_COMPLIANT
- **Description:** The tenancy must continuously evaluate against the CIS VMware Foundations Benchmark v2.0 in Cloud Guard.
...
### `VMware-GOV-004`: Enforce Compartment Quota Policies to Prevent Unauthorized Compute/GPU Proliferation
