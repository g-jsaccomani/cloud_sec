# VMWARE - Incident Response Dr Security Profile
...
### `VMware-DR-001`: Enforce Immutable Retention Rules on VMware Object Storage Backup Buckets
...
### `VMware-DR-002`: Enforce Cross-Region Copy in Block Volume Backup Policies
...
### `VMware-DR-003`: Configure VMware Full Stack Disaster Recovery (FSDR) for Tier-0 Applications
...
### `VMware-DR-004`: Configure Automated Block Volume Forensic Cloning Runbooks
